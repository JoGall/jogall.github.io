...
There might be the __slightest__ positive relationship here, but I'm really not convinced there's anything going on.. Not even statistical tests can discount common sense as a linear regression (yes, a regression fitted to regression coefficients) is not significant.
...
gganimate(p, interval = c(rep(0.5, 24), 2), loop = TRUE)
```
...
https://a.disquscdn.com/get?url=https%3A%2F%2Fuser-images.githubusercontent.com%2F17113779%2F29029674-6b68b3de-7b80-11e7-93f3-a12f088b0c0f.png&key=JpJIaLVXOEfMd3aix1b8gQ&w=800&h=458
